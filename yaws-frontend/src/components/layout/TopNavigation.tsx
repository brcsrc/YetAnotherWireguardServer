...
const TopNavigationBar = (): JSX.Element => {
    ...
    const utilities = [
        {
            ...
            ariaLabel: "Links",
            items: [
                { id: "wireguard", text: "WireGuard Docs", href: "https://www.wireguard.com/", external: true },
                { id: "github", text: "GitHub Repository", href: "https://github.com/brcsrc/YetAnotherWireguardServer", external: true }
            ]
        }
    ];
    ...
    if (username) {
        ...
        utilities.push({
            ...
            onItemClick: ({ detail }) => {if (detail.id === "logout") logout();},
        });
    }
