...
import {NETWORKS_TABLE_COL_DEF, NETWORKS_TABLE_FILTER_PROPS, NETWORKS_TABLE_PREFERENCES} from "./networksTableUtilities";
...
const NetworksTable = (): React.ReactNode => {
  ...
  const [preferences, setPreferences] = useState({
    pageSize: 10,
    visibleContent: ["name", "cidr", "port", "tag", "status"]
  })
